  ...
  return (
    <footer className="bg-background border-t border-border text-muted-foreground">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-display text-sm tracking-[0.2em] uppercase text-foreground font-medium">
                Wesoły Masaż
              </span>
            </div>
            ...
            <div className="flex gap-4 mt-8">
              <a
                ...
                className="w-10 h-10 border border-border flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300"
              >
                <Instagram size={16} />
              </a>
              <a
                href="https://wa.me/48787907141"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 border border-border flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300"
              >
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-foreground text-xs tracking-[0.2em] uppercase mb-6">Nawigacja</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-foreground text-xs tracking-[0.2em] uppercase mb-6">Kontakt</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Phone size={14} className="text-gold mt-1 flex-shrink-0" />
                <a href="tel:+48787907141" className="text-sm text-foreground/50 hover:text-foreground transition-colors">
                  +48 787907141
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={14} className="text-gold mt-1 flex-shrink-0" />
                <a href="mailto:irena@wesolymasaz.pl" className="text-sm text-foreground/50 hover:text-foreground transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-foreground/30 tracking-wider">
         <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-foreground/30 tracking-wider">
  <p>© {new Date().getFullYear()} Wesoły Masaż. Wszelkie prawa zastrzeżone.</p>
  <a href="https://synapsehub.pl" target="_blank" rel="noopener noreferrer" className="hover:text-foreground/50 transition-colors">
