...
function StepConfirmation({ booking }) {
  return (
    ...
    >
      ...
      <h2 className="font-display text-3xl lg:text-4xl text-obsidian mb-4">Rezerwacja potwierdzona!</h2>
      <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
        Wysłaliśmy potwierdzenie na <strong>{booking.client_email}</strong>. Dzień przed wizytą przypomnę Ci przez WhatsApp.
      </p>
      <div className="border border-gold/20 bg-gold/5 p-6 max-w-sm mx-auto text-left mb-10">
