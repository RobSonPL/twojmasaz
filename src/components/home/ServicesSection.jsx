...
const defaultServices = [
  ...
  { id: '4', name: 'Masaż Gorącymi Kamieniami', category: 'specjalistyczny', price: 200, duration_minutes: 60, description: 'Masaż bazaltowymi kamieniami wulkanicznymi — głęboka relaksacja i poprawa metabolizmu.', is_available_home: true, is_available_studio: true, image_url: 'https://images.unsplash.com/photo-1580161520529-5e2e0a3a6d6b?w=800&q=80&auto=format&fit=crop' },
  ...
  { id: '6', name: 'Masaż Twarzy', category: 'specjalistyczny', price: 100, duration_minutes: 30, description: 'Delikatny lifting manualny i drenaż limfatyczny — promienna cera i redukcja napięć.', is_available_home: true, is_available_studio: true, image_url: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=800&q=80&auto=format&fit=crop' },
