...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-24 h-24 rounded-full border border-gold flex items-center justify-center backdrop-blur-sm bg-secondary/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-7">
            ...
            <motion.p
              ...
              className="text-foreground/50 text-lg max-w-md leading-relaxed font-body"
            >
          ...
          >
            <div className="border-l border-gold/30 pl-6">
              <div className="font-mono text-4xl text-foreground font-medium">4.9</div>
      ...
      <motion.div
        ...
        >
        <a href="#uslugi" className="flex flex-col items-center gap-2 text-foreground/30 hover:text-gold transition-colors group">
          <span className="text-xs tracking-widest uppercase">Przewiń</span>
          <motion.div
            animate={{ y: [0, 6, 0] }}
            transition={{ repeat: Infinity, duration: 2 }}
            className="w-px h-10 bg-gradient-to-b from-foreground/30 to-transparent group-hover:from-gold/50"
          />
        </a>
      </motion.div>
    </section>
