...
export default function HowItWorksSection() {
  return (
    <section id="jak-to-dziala" className="section-padding bg-secondary/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative border-r border-border last:border-r-0 px-0 md:px-10 first:pl-0 last:pr-0 pb-16 md:pb-0"
            >
        ...
        >
          ...
          <span className="text-foreground/30 text-sm">Bez karty kredytowej · Bez rejestracji · 60 sekund</span>
        </motion.div>
      </div>
    </section>
  );
