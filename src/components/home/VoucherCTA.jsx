      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-8 -right-8 lg:right-8 w-48 h-28 bg-card p-4 border border-gold/20">
              <div className="font-mono text-xs text-gold/60 tracking-widest mb-2">VOUCHER</div>
              <div className="font-display text-xl text-foreground">250 PLN</div>
              <div className="font-mono text-xs text-foreground/30 mt-1">WESOŁY MASAŻ</div>
            </div>
          </motion.div>
